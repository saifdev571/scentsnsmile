        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="flex gap-4 w-full">
                ...
                <div class="flex flex-col gap-3 w-20 md:w-24 flex-shrink-0">
                    ...
                    <button onclick="changeMainImage('<?php echo e($image); ?>', this)" class="thumbnail-btn border-2 <?php echo e($index === 0 ? 'border-black' : 'border-gray-300'); ?> rounded-lg overflow-hidden hover:border-black transition-all duration-200">
                        <img src="<?php echo e($image); ?>" alt="Thumbnail <?php echo e($index + 1); ?>" class="w-full aspect-square object-cover">
                    </button>
                ...
                <div class="flex-1 min-w-0 relative">
                    ...
                    <div class="absolute top-4 left-4 z-10 flex gap-2">
                        ...
                        <span class="bg-white text-red-500 px-3 py-1 rounded-full text-xs font-bold border-2 border-red-500 shadow-sm"><?php echo e($product->genders->first()->name); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="absolute top-4 right-4 z-10">
                        <div class="bg-black text-white rounded-full w-16 h-16 flex flex-col items-center justify-center shadow-lg">
                    ...
                    <div class="bg-[#f5f5f0] rounded-2xl overflow-hidden aspect-square relative w-full">
                        <img id="mainProductImage" src="<?php echo e($product->image_url ?? 'https://images.pexels.com/photos/965989/pexels-photo-965989.jpeg?auto=compress&cs=tinysrgb&w=800'); ?>" 
                        ...
                        <div class="absolute right-4 bottom-4 flex gap-2">
                            <button onclick="previousProductImage()" class="w-12 h-12 bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full flex items-center justify-center shadow-lg transition-all duration-200">
                                <svg class="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 19l-7-7 7-7"/>
                                </svg>
                            </button>
                            <button onclick="nextProductImage()" class="w-12 h-12 bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full flex items-center justify-center shadow-lg transition-all duration-200">
                                <svg class="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="text-sm text-gray-600 underline hover:text-gray-900 cursor-pointer">(<?php echo e($reviewCount); ?> reviews)</span>
                        <?php else: ?>
                    ...
                    <div class="text-sm text-gray-700 mb-3 leading-relaxed"><?php echo strip_tags($product->scent_note ?? $product->short_description); ?></div>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                    <p class="text-sm">
                        <span class="font-bold text-gray-900">Brand:</span> <span class="text-gray-700"><?php echo e($product->brand->name); ?></span>
                    </p>
                </div>
                <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="border border-gray-300 px-3 py-1.5 rounded-lg text-sm font-medium hover:border-black hover:bg-gray-50 cursor-pointer transition-all duration-200"><?php echo e($size->name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-bold text-[#e8a598] capitalize"><?php echo e(ucfirst($product->scent_intensity)); ?></span>
                        <?php
                            $dots = $product->scent_intensity === 'soft' ? 1 : ($product->scent_intensity === 'significant' ? 2 : 3);
                        ?>
                        <div class="flex items-center gap-1">
                            <?php for($i = 1; $i <= 3; $i++): ?>
                                <span class="w-2 h-2 rounded-full <?php echo e($i <= $dots ? 'bg-[#e8a598]' : 'bg-gray-300'); ?>"></span>
                            <?php endfor; ?>
                        </div>
                        <button onclick="openScentIntensityModal()" class="w-5 h-5 rounded-full bg-gray-400 text-white flex items-center justify-center text-xs hover:bg-gray-500 transition-all duration-200">
                            ?
                        </button>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    <div class="flex items-center justify-between mb-3">
                        <div>
                            <div class="flex items-center gap-2">
                                <?php if($product->sale_price && $product->sale_price < $product->price): ?>
                                <span class="text-3xl font-black text-[#e8a598]">₹<?php echo e(number_format($product->sale_price, 2)); ?></span>
                                <span class="text-xl text-gray-400 line-through">₹<?php echo e(number_format($product->price, 2)); ?></span>
                                <?php else: ?>
                                <span class="text-3xl font-black text-[#e8a598]">₹<?php echo e(number_format($product->price, 2)); ?></span>
                                <?php endif; ?>
                            </div>
                            <?php if($product->sale_price && $product->sale_price < $product->price): ?>
                            <p class="text-xs text-green-600 font-medium mt-0.5">Save ₹<?php echo e(number_format($product->price - $product->sale_price, 2)); ?></p>
                            <?php endif; ?>
                        </div>
                        <button class="w-9 h-9 border-2 border-gray-300 rounded-full flex items-center justify-center hover:border-red-500 hover:text-red-500 hover:bg-red-50 transition-all duration-200">
                    ...
                    <button onclick="addToCart(<?php echo e($product->id); ?>)" class="w-full bg-[#e8a598] hover:bg-[#d4948a] text-white font-bold py-3 rounded-full text-base transition-all duration-200 hover:shadow-lg mb-4">
                        ADD TO CART
                    </button>

                    <!-- Secure Checkout -->
                    <div class="text-center mb-4">
                        <h3 class="text-sm font-semibold text-gray-700 mb-3">Secure Checkout With</h3>
                        <div class="flex items-center justify-center gap-2">
                            <div class="bg-white rounded-lg p-2 shadow-sm border border-gray-200">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/200px-Mastercard-logo.svg.png" alt="Mastercard" class="h-5 object-contain">
                            </div>
                            <div class="bg-white rounded-lg p-2 shadow-sm border border-gray-200">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/200px-Visa_Inc._logo.svg.png" alt="Visa" class="h-5 object-contain">
                            </div>
                            <div class="bg-white rounded-lg p-2 shadow-sm border border-gray-200">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/American_Express_logo_%282018%29.svg/200px-American_Express_logo_%282018%29.svg.png" alt="American Express" class="h-5 object-contain">
                            </div>
                            <div class="bg-white rounded-lg p-2 shadow-sm border border-gray-200">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Apple_Pay_logo.svg/200px-Apple_Pay_logo.svg.png" alt="Apple Pay" class="h-5 object-contain">
                            </div>
                        </div>
                    </div>

                    <!-- Shipping Info Banner -->
                    <div class="bg-[#f5ecd7] rounded-lg p-3 text-[#5c4033] border border-[#e8d4a8]">
                        <div class="flex items-center gap-1.5 mb-1">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"/>
                                <path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7a1 1 0 00-1 1v6.05A2.5 2.5 0 0115.95 16H17a1 1 0 001-1v-5a1 1 0 00-.293-.707l-2-2A1 1 0 0015 7h-1z"/>
                            </svg>
                            <span class="text-sm font-semibold">Free Shipping</span>
                        </div>
                        <p class="text-xs leading-relaxed">
                            Order within the next <span id="shippingCountdown" class="font-bold text-[#e8a598]">--</span> for dispatch today
                        </p>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="relative flex items-center gap-2">
                        <!-- Left Arrow -->
                        <button onclick="slideTabsLeft()" id="tabSlideLeft" class="flex-shrink-0 w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-all duration-200 hidden">
                        ...
                        <!-- Right Arrow -->
                        <button onclick="slideTabsRight()" id="tabSlideRight" class="flex-shrink-0 w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-all duration-200">
                    ...
                    <div class="relative mt-3">
                        ...
                        <div id="aboutScentProductContent" class="product-tab-content hidden" data-tab="aboutScent">
                            <div class="border border-gray-200 rounded-xl bg-gray-50 p-3 max-h-48 overflow-y-auto custom-scrollbar">
                                        ...
                                        <div class="flex flex-wrap gap-2 not-prose">
                                            ...
                                            <div class="flex items-center gap-2 px-3 py-1.5 bg-white rounded-full border border-gray-200 shadow-sm">
                                                <?php if($note->imagekit_thumbnail_url || $note->imagekit_url): ?>
                                                    <img src="<?php echo e($note->imagekit_thumbnail_url ?? $note->imagekit_url); ?>" alt="<?php echo e($note->name); ?>" class="w-5 h-5 object-contain">
                                                <?php endif; ?>
            ...
            <a href="<?php echo e(route('product.show', $related->slug)); ?>" class="group">
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition">
                    <div class="aspect-square bg-[#f5f5f0] relative overflow-hidden">
                        <img src="<?php echo e($related->image_url); ?>" alt="<?php echo e($related->name); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-3">
                        ...
                        <div class="flex items-center gap-2 mt-1">
                            ...
                            <span class="text-gray-400 text-sm line-through">₹<?php echo e(number_format($related->price, 2)); ?></span>
                            <?php else: ?>
