        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="flex gap-3">
                ...
                <div class="flex flex-col gap-2 w-20">
                    ...
                    <button onclick="changeMainImage('<?php echo e($image); ?>', this)" class="thumbnail-btn border-2 <?php echo e($index === 0 ? 'border-black' : 'border-gray-300'); ?> rounded-lg overflow-hidden hover:border-black transition">
                ...
                <div class="flex-1 relative">
                    ...
                    <div class="absolute top-3 left-3 z-10 flex gap-2">
                        ...
                        <span class="bg-white text-red-500 px-3 py-1 rounded-full text-xs font-bold border-2 border-red-500"><?php echo e($product->genders->first()->name); ?></span>
                        <?php endif; ?>
                        <?php if($product->is_bestseller || $product->is_featured): ?>
                    ...
                    <div class="absolute top-3 right-3 z-10">
                        <div class="bg-black text-white rounded-full w-16 h-16 flex flex-col items-center justify-center">
                            ...
                            <span class="text-lg font-black leading-none"><?php echo e($discount); ?>%</span>
            ...
            <div class="space-y-4">
                <!-- Product Title -->
                <div>
                    <h1 class="text-2xl md:text-3xl font-black uppercase mb-2"><?php echo e($product->name); ?></h1>
                    
                    <!-- Rating -->
                    <div class="flex items-center gap-2 mb-2">
                        <div class="flex items-center text-black text-sm">★★★★★</div>
                        <span class="text-sm text-gray-600 underline">(<?php echo e(rand(100, 500)); ?> reviews)</span>
                    </div>

                    <!-- Product Type / Scent Note -->
                    <?php if($product->scent_note || $product->short_description): ?>
                    <div class="text-sm text-gray-600 mb-3"><?php echo strip_tags($product->scent_note ?? $product->short_description); ?></div>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-3">
                    <p class="text-sm">
                        <span class="font-bold">Brand:</span> <?php echo e($product->brand->name); ?>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-xs"><?php echo e($tag->name); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="border border-gray-300 px-3 py-1 rounded-lg text-sm hover:border-black cursor-pointer transition"><?php echo e($size->name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="border-t pt-4">
                    <div class="flex items-center justify-between mb-3">
                        <div>
                            ...
                            <?php if($product->sale_price && $product->sale_price < $product->price): ?>
                            <p class="text-xs text-gray-500 mt-0.5">Save ₹<?php echo e(number_format($product->price - $product->sale_price, 2)); ?></p>
                            <?php endif; ?>
                        </div>
                    ...
                    <button onclick="addToCart(<?php echo e($product->id); ?>)" class="w-full bg-[#e8a598] hover:bg-[#d4948a] text-white font-bold py-3 rounded-full text-base transition-colors mb-4">
                        ADD TO CART
                    </button>
