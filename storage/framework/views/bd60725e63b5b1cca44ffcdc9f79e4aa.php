        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200">
            <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                <div class="flex items-center space-x-3">
                    <div
                        class="w-12 h-12 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center shadow-lg">
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Product Name -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Product Name <span
                        ...
                        <input type="text" name="name" id="productName" required
                            ...
                            placeholder="Enter product name" oninput="updateSlug()">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- URL Slug -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">URL Slug <span
                                class="text-blue-500 text-xs">(Auto-generated)</span></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="border-t border-gray-200 pt-6 mt-6">
                    <div class="flex items-center space-x-3 mb-4">
                        <div
                            class="w-10 h-10 bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg flex items-center justify-center shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- Inspired By Text -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-800 mb-2">Inspired By <span
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Retail Price -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-800 mb-2">Retail Price <span
                                    class="text-gray-500 text-xs">(Optional)</span></label>
                            <div class="relative">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <input type="text" id="retailPriceColorText"
                                    ...
                                    placeholder="#B8860B" maxlength="7">
                            </div>
                    ...
                    <div class="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900" id="previewInspiredBy">
                                <?php echo e($productData['inspired_by'] ?? "MFK's Baccarat Rouge 540"); ?></p>
                            <p class="text-sm font-medium" id="previewRetailPrice"
                                style="color: <?php echo e($productData['retail_price_color'] ?? '#B8860B'); ?>;">(RETAIL PRICE: RS.
                                <?php echo e(number_format($productData['retail_price'] ?? 27400)); ?>)</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div x-data="highlightNotesDropdown()">
                        ...
                        <div class="relative">
                            <button @click="open = !open" type="button"
                                class="w-full px-4 py-3 text-left border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 hover:border-gray-400 flex justify-between items-center">
                                <span x-text="selectedCount > 0 ? selectedCount + ' notes selected' : 'Select highlight notes'"
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <input type="text" placeholder="Search notes..." x-model="search"
                ...
                <?php if(isset($scentFamilies) && $scentFamilies->count() > 0): ?>
                    <div x-data="scentFamiliesDropdown()">
                        ...
                        <div class="relative">
                            <button @click="open = !open" type="button"
                                class="w-full px-4 py-3 text-left border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-gray-400 flex justify-between items-center">
                                <span
                                    x-text="selectedCount > 0 ? selectedCount + ' families selected' : 'Select scent families'"
                                    class="truncate text-gray-700"></span>
                                <svg class="w-4 h-4 ml-2 text-gray-500 transition-transform duration-200 flex-shrink-0"
                                    :class="{'rotate-180': open}" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <div x-show="open" @click.away="open = false"
                                class="absolute z-20 mt-2 w-full bg-white border-2 border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                <input type="text" placeholder="Search families..." x-model="search"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Soft -->
                        <label
                            class="relative flex flex-col p-4 bg-gray-50 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-purple-400 hover:bg-purple-50 transition-all duration-200 group has-[:checked]:border-purple-500 has-[:checked]:bg-purple-50">
                            ...
                            <div class="flex items-center gap-3 mb-2">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center flex-shrink-0">
                            ...
                            <p class="text-sm text-gray-600 mt-2">Light, airy fragrance that stays close to the skin.
                                Perfect for everyday wear and intimate settings.</p>
                        </label>
                        ...
                        <label
                            ...
                            <p class="text-sm text-gray-600 mt-2">Moderate projection with good presence. Noticeable without
                                being overwhelming. Ideal for most occasions.</p>
                        </label>
                        ...
                        <label
                            ...
                            <div class="flex items-center gap-3 mb-2">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gradient-to-br from-pink-100 to-red-100 flex items-center justify-center flex-shrink-0">
                                    <span class="text-2xl">🌹</span>
                                </div>
                                <div>
                            ...
                            <p class="text-sm text-gray-600 mt-2">Strong, commanding presence with excellent sillage. Makes
                                a lasting impression. Best for special occasions.</p>
                        </label>
                    </div>
                ...
                <?php if(isset($moments) && $moments->count() > 0): ?>
                    <div x-data="momentsDropdown()">
                        ...
                        <div class="relative">
                            <button @click="open = !open" type="button"
                                class="w-full px-4 py-3 text-left border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-all duration-200 hover:border-gray-400 flex justify-between items-center">
                                <span x-text="selectedCount > 0 ? selectedCount + ' moments selected' : 'Select moments...'"
                                    class="truncate text-gray-700"></span>
                                <svg class="w-4 h-4 ml-2 text-gray-500 transition-transform duration-200 flex-shrink-0"
                                    :class="{'rotate-180': open}" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <div x-show="open" @click.away="open = false"
                                class="absolute z-20 mt-2 w-full bg-white border-2 border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                <input type="text" placeholder="Search moments..." x-model="search"
                                    class="w-full px-3 py-2 border-b border-gray-200 focus:outline-none focus:ring-1 focus:ring-pink-500">
                                <template x-for="moment in filteredMoments" :key="moment.id">
                                    <label class="flex items-center px-4 py-2 cursor-pointer hover:bg-pink-50">
                                        <input type="checkbox" :value="moment.id" x-model="selected" name="moments[]"
                                            class="w-4 h-4 text-pink-500 border-gray-300 rounded focus:ring-pink-500 mr-3">
                                        <span x-text="moment.name" class="text-sm text-gray-700"></span>
                                    </label>
                                </template>
                                <div x-show="filteredMoments.length === 0" class="px-4 py-2 text-gray-400">No results found.
                                </div>
                            </div>
                        </div>
                        <p class="text-xs text-gray-500 mt-2">Select moments/occasions this fragrance is perfect for
                            (searchable, multiple selection)</p>
                    </div>
                <?php endif; ?>
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="flex items-center space-x-3 mb-6">
                        <div
                            class="w-10 h-10 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg flex items-center justify-center shadow-lg">
                            <span class="text-white text-lg">📋</span>
                        </div>
                        <div>
                ...
                <!-- About This Scent -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">About This Scent <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="aboutScentSection">
                        <div id="aboutScentEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="about_scent" id="aboutScentHidden"
                        class="hidden"><?php echo e(old('about_scent', $productData['about_scent'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Describe the scent profile and character</p>
                </div>

                <!-- Fragrance Notes -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Fragrance Notes <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="fragranceNotesSection">
                        <div id="fragranceNotesEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="fragrance_notes" id="fragranceNotesHidden"
                        class="hidden"><?php echo e(old('fragrance_notes', $productData['fragrance_notes'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Top, middle, and base notes</p>
                </div>

                <!-- Why You'll Love It -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Why You'll Love It <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="whyLoveSection">
                        <div id="whyLoveEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="why_love_it" id="whyLoveHidden"
                        class="hidden"><?php echo e(old('why_love_it', $productData['why_love_it'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Key selling points and benefits</p>
                </div>

                <!-- What Makes It Clean -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">What Makes It Clean <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="whatCleanSection">
                        <div id="whatCleanEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="what_makes_clean" id="whatCleanHidden"
                        class="hidden"><?php echo e(old('what_makes_clean', $productData['what_makes_clean'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Clean beauty and sustainability info</p>
                </div>

                <!-- Ingredients and Details -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Ingredients and Details <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="ingredientsDetailsSection">
                        <div id="ingredientsDetailsEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="ingredients_details" id="ingredientsDetailsHidden"
                        class="hidden"><?php echo e(old('ingredients_details', $productData['ingredients_details'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Full ingredients list and product details</p>
                </div>

                <!-- Shipping Information -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Shipping Information <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="shippingInfoSection">
                        <div id="shippingInfoEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="shipping_info" id="shippingInfoHidden"
                        class="hidden"><?php echo e(old('shipping_info', $productData['shipping_info'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Shipping times, costs, and policies</p>
                </div>

                <!-- Disclaimer -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Disclaimer <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="disclaimerSection">
                        <div id="disclaimerEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="disclaimer" id="disclaimerHidden"
                        class="hidden"><?php echo e(old('disclaimer', $productData['disclaimer'] ?? '')); ?></textarea>
                    <p class="text-xs text-gray-500 mt-1">Legal disclaimers and warnings</p>
                </div>

                <!-- Ask a Question -->
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Ask a Question <span
                            class="text-gray-500 text-xs">(Optional)</span></label>
                    <div class="quill-editor-wrapper" id="askQuestionSection">
                        <div id="askQuestionEditor" style="height: 200px;"></div>
                    </div>
                    <textarea name="ask_question" id="askQuestionHidden"
                        class="hidden"><?php echo e(old('ask_question', $productData['ask_question'] ?? '')); ?></textarea>
        ...
        <script>
            ...
            function momentsDropdown() {
                return {
                    open: false,
                    search: '',
                    selected: <?php echo json_encode(array_map('intval', old('moments', $productData['moments'] ?? []))) ?>,
                    moments: <?php echo json_encode($moments, 15, 512) ?>,
            ...
            function highlightNotesDropdown() {
                return {
                    open: false,
                    search: '',
                    selected: <?php echo json_encode(array_map('intval', old('highlight_notes', $productData['highlight_notes'] ?? []))) ?>,
            ...
            function scentFamiliesDropdown() {
                return {
                    open: false,
                    search: '',
                    selected: <?php echo json_encode(array_map('intval', old('scent_families', $productData['scent_families'] ?? []))) ?>,
...
<?php echo $__env->make('admin.products.edit._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/products/edit/step1.blade.php ENDPATH**/ ?>