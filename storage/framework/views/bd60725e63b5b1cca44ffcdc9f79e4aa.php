...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900" id="previewInspiredBy"><?php echo e($productData['inspired_by'] ?? "MFK's Baccarat Rouge 540"); ?></p>
                        <p class="text-sm font-medium" id="previewRetailPrice" style="color: <?php echo e($productData['retail_price_color'] ?? '#B8860B'); ?>;">(RETAIL PRICE: RS. <?php echo e(number_format($productData['retail_price'] ?? 27400)); ?>)</p>
                    </div>
                </div>
            </div>
...
function momentsDropdown() {
    return {
        open: false,
        search: '',
        selected: <?php echo json_encode(old('moments', $productData['moments'] ?? []), 512) ?>,
