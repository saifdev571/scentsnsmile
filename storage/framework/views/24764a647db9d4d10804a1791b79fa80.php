...
<div id="social-tab" class="<?php echo e($activeTab === 'social' ? '' : 'hidden'); ?>">
    <div class="bg-white shadow-xl rounded-2xl border border-gray-200">
        ...
        <div class="px-8 py-6">
            <form id="social-form" method="POST" action="<?php echo e(route('admin.settings.social')); ?>">
                <?php echo csrf_field(); ?>
                <div class="space-y-6">
                    <!-- Facebook -->
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_facebook" id="social_facebook" 
                                   value="<?php echo e(old('social_facebook', $settings['social_facebook'])); ?>"
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_twitter" id="social_twitter" 
                                   value="<?php echo e(old('social_twitter', $settings['social_twitter'])); ?>"
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_instagram" id="social_instagram" 
                                   value="<?php echo e(old('social_instagram', $settings['social_instagram'])); ?>"
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_linkedin" id="social_linkedin" 
                                   value="<?php echo e(old('social_linkedin', $settings['social_linkedin'])); ?>"
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="social_youtube" id="social_youtube" 
                                   value="<?php echo e(old('social_youtube', $settings['social_youtube'])); ?>"
...
<?php /**PATH /Applications/XAMPP/htdocs/scentnsmile/resources/views/admin/settings/partials/social-media-tab.blade.php ENDPATH**/ ?>