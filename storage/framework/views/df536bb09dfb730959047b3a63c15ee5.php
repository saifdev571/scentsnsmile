    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-purple-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">₹<?php echo e(number_format($totalRevenue ?? 0, 0)); ?></p>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                            ...
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" value="<?php echo e($order->id); ?>">
                            </td>

                            <!-- Order Number -->
                            <td class="px-4 py-4">
                                <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="text-sm font-bold text-blue-600 hover:text-blue-800 hover:underline">
                            ...
                            <td class="px-4 py-4">
                                <div>
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($order->user->name ?? ($order->first_name . ' ' . $order->last_name)); ?></p>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" title="View Order">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600"><?php echo e($orders->firstItem() ?? 0); ?></span> to <span class="font-bold text-blue-600"><?php echo e($orders->lastItem() ?? 0); ?></span> of <span class="font-bold text-blue-600"><?php echo e($orders->total()); ?></span> entries
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo $__env->make('admin.orders.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>