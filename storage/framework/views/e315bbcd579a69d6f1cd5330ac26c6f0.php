                                ...
                                <div class="bg-white rounded-xl overflow-hidden p-1">
                                    <div class="group/scent relative">
                                        ...
                                        <div class="hidden group-hover/scent:block pl-4 pr-1 pb-1 space-y-1 bg-gray-50 rounded-b-xl border-t border-gray-100">
                                            <?php $__currentLoopData = $scentFamilies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('scent-families', ['scent' => $family->slug])); ?>"
                                                    ...
                                                    <?php if($family->imagekit_url): ?>
                                                        <img src="<?php echo e($family->imagekit_thumbnail_url ?? $family->imagekit_url); ?>"
                                                            alt="<?php echo e($family->name); ?>"
                                                            class="w-8 h-8 rounded-lg object-cover shadow-sm">
                                                    <?php else: ?>
                                                        <div class="w-8 h-8 rounded-lg bg-gray-200 flex items-center justify-center">
                                                            <span
                                                                class="text-[10px] font-bold text-gray-500"><?php echo e(substr($family->name, 0, 1)); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                    <span class="text-xs font-medium text-gray-700 group-hover/item:text-gray-900"><?php echo e($family->name); ?></span>
                                                </a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
...
</div><?php /**PATH /Applications/XAMPP/htdocs/scentnsmile/resources/views/partials/header.blade.php ENDPATH**/ ?>