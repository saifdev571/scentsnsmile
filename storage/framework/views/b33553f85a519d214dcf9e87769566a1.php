...
<?php $__env->startSection('step_title', 'Step 2: Media & Images'); ?>
<?php $__env->startSection('step_description', 'Upload product images and media'); ?>
...
<form id="stepForm" action="<?php echo e(route('admin.products.edit.step2.process', $product->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="p-8 space-y-8">
            ...
            <div>
                ...
                <input type="hidden" name="additional_images" id="additionalImagesData" value="<?php echo e(old('additional_images', json_encode($product->images ?? []))); ?>">
...
<?php echo $__env->make('admin.products.edit._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/products/edit/step2.blade.php ENDPATH**/ ?>