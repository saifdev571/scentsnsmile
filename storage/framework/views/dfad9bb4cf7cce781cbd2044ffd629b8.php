<!-- SEO Settings Tab -->
<div id="seo-tab" class="<?php echo e($activeTab === 'seo' ? '' : 'hidden'); ?>">
    <div class="bg-white shadow-xl rounded-2xl border border-gray-200">
        ...
        <div class="px-8 py-6">
            <form id="seo-form" method="POST" action="<?php echo e(route('admin.settings.seo')); ?>">
                <?php echo csrf_field(); ?>
                <div class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="seo_meta_title" id="seo_meta_title" 
                               value="<?php echo e(old('seo_meta_title', $settings['seo_meta_title'])); ?>"
                               maxlength="60"
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            <span id="meta-title-count"><?php echo e(strlen($settings['seo_meta_title'])); ?></span>/60 characters
                        </p>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <textarea name="seo_meta_description" id="seo_meta_description" 
                                  ...
                                  maxlength="160"
                                  class="block w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 text-sm"
                                  placeholder="Shop the best products online with fast shipping and great prices. Find everything you need in one place."><?php echo e(old('seo_meta_description', $settings['seo_meta_description'])); ?></textarea>
                        <p class="mt-1 text-xs text-gray-500">
                            <span id="meta-desc-count"><?php echo e(strlen($settings['seo_meta_description'])); ?></span>/160 characters
                        </p>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="seo_meta_keywords" id="seo_meta_keywords" 
                               value="<?php echo e(old('seo_meta_keywords', $settings['seo_meta_keywords'])); ?>"
                               class="block w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 text-sm"
                    ...
                    <div class="group">
                        ...
                        <div class="flex items-center space-x-4">
                            <?php if($settings['seo_og_image']): ?>
                                <img id="og-image-preview" src="<?php echo e($settings['seo_og_image']); ?>" alt="OG Image" class="w-48 h-24 object-cover border-2 border-gray-200 rounded-lg">
                            <?php else: ?>
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="seo_google_analytics" id="seo_google_analytics" 
                               value="<?php echo e(old('seo_google_analytics', $settings['seo_google_analytics'])); ?>"
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="seo_google_site_verification" id="seo_google_site_verification" 
                               value="<?php echo e(old('seo_google_site_verification', $settings['seo_google_site_verification'])); ?>"
                               class="block w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 text-sm font-mono"
                    ...
                    <div class="border-2 border-gray-200 rounded-xl p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="seo_sitemap_enabled" value="1" <?php echo e($settings['seo_sitemap_enabled'] ? 'checked' : ''); ?> class="sr-only peer">
                        ...
                        <p class="mt-2 text-xs text-gray-500">Current sitemap: <a href="<?php echo e(url('/sitemap.xml')); ?>" target="_blank" class="text-green-600 hover:underline"><?php echo e(url('/sitemap.xml')); ?></a></p>
                    </div>
                </div>
...
document.getElementById('og-image-upload')?.addEventListener('change', function(e) {
    if (e.target.files.length > 0) {
        ...
        fetch('<?php echo e(route("admin.settings.uploadOGImage")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
function generateSitemap() {
    fetch('<?php echo e(route("admin.settings.generateSitemap")); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
<?php /**PATH /Applications/XAMPP/htdocs/scentnsmile/resources/views/admin/settings/partials/seo-tab.blade.php ENDPATH**/ ?>