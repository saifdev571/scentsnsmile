...
<form id="stepForm" action="<?php echo e(route('admin.products.create.step2.process')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="p-8 space-y-8">
            ...
            <div>
                ...
                <input type="hidden" name="additional_images" id="additionalImagesData" value="<?php echo e(old('additional_images', $productData['additional_images'] ?? '[]')); ?>">
...
<?php echo $__env->make('admin.products.create._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/products/create/step2.blade.php ENDPATH**/ ?>