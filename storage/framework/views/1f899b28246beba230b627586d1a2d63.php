...
<?php $__env->startSection('title', $pageTitle ?? 'My Account - Scents N Smile'); ?>
...
<div class="bg-gray-100 min-h-screen pt-20 lg:pt-24">
    ...
    <div class="lg:hidden bg-white shadow-sm mx-4 rounded-lg mb-4">
        <div class="flex items-center justify-between px-4 py-3">
            <a href="<?php echo e(route('home')); ?>" class="text-gray-600">
        ...
        <div class="flex flex-col lg:flex-row gap-4 lg:gap-6">
            ...
            <div class="hidden lg:block w-72 flex-shrink-0">
                    ...
                    <div class="bg-gradient-to-r from-[#e8a598] to-[#F27F6E] p-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="text-white">
                                ...
                                <p class="font-semibold text-lg"><?php echo e($user->name); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <!-- My Orders -->
                    <a href="<?php echo e(route('user.orders')); ?>" class="flex items-center gap-4 px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors">
            ...
            <div class="lg:hidden space-y-3">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            <p class="font-semibold text-lg text-gray-900"><?php echo e($user->name); ?></p>
                            <p class="text-sm text-gray-500"><?php echo e($user->email); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($user->phone ?? 'Add phone number'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <a href="<?php echo e(route('user.orders')); ?>" class="bg-white rounded-lg shadow-sm p-4 flex flex-col items-center gap-2 hover:shadow-md transition-shadow">
            ...
            <div class="flex-1 space-y-4">
                ...
                <div id="profileTab" class="bg-white rounded-lg shadow-sm">
                    ...
                    <form action="<?php echo e(route('user.profile.update')); ?>" method="POST" class="p-4 lg:p-6">
                        <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4 mt-3">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="gender" value="male" <?php echo e(($user->gender ?? '') == 'male' ? 'checked' : ''); ?>

                                               class="w-4 h-4 text-[#e8a598] focus:ring-[#e8a598]">
                                        <span class="text-sm text-gray-700">Male</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="gender" value="female" <?php echo e(($user->gender ?? '') == 'female' ? 'checked' : ''); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <form action="<?php echo e(route('user.password.update')); ?>" method="POST" class="p-4 lg:p-6">
                        <?php echo csrf_field(); ?>
                ...
                <div id="addressesTab" class="bg-white rounded-lg shadow-sm hidden">
                    ...
                    <div class="p-4 lg:p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4 relative <?php echo e($address->is_default ? 'border-[#e8a598] bg-[#e8a598]/5' : ''); ?>">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                            <span class="font-semibold text-gray-900"><?php echo e($address->name); ?></span>
                                            <span class="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded uppercase"><?php echo e($address->type ?? 'Home'); ?></span>
                                        </div>
                                        <p class="text-sm text-gray-600 mb-1"><?php echo e($address->phone); ?></p>
                                ...
                                <div class="flex items-center gap-3 mt-4 pt-3 border-t border-gray-100">
                                    <button onclick="editAddress(<?php echo e($address->id); ?>)" class="text-sm text-[#e8a598] font-medium hover:underline">Edit</button>
                                    <span class="text-gray-300">|</span>
                                    <form action="<?php echo e(route('user.address.delete', $address->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this address?')">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php if(!$address->is_default): ?>
                                    <span class="text-gray-300">|</span>
                                    <form action="<?php echo e(route('user.address.default', $address->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
...
<div id="addressModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute inset-x-4 top-1/2 -translate-y-1/2 max-w-lg mx-auto bg-white rounded-xl shadow-xl max-h-[90vh] overflow-y-auto lg:inset-x-auto">
        ...
        <form id="addressForm" action="<?php echo e(route('user.address.store')); ?>" method="POST" class="p-4">
            <?php echo csrf_field(); ?>
...
<script>
    ...
    function openAddressModal() {
        ...
        document.getElementById('addressForm').action = "<?php echo e(route('user.address.store')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/website/auth/account.blade.php ENDPATH**/ ?>