<?php if($products->count() > 0): ?>
    <?php
        $visualIndex = ($products->currentPage() - 1) * $products->perPage();
    ?>

    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
        <?php while(isset($promotionalCards) && $promotionalCards->has($visualIndex)): ?>
            <?php echo $__env->make('partials.promo-card', ['card' => $promotionalCards[$visualIndex]], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php $visualIndex++; ?>
        <?php endwhile; ?>
...
<?php endif; ?><?php /**PATH /Applications/XAMPP/htdocs/scentnsmile/resources/views/partials/products-grid.blade.php ENDPATH**/ ?>