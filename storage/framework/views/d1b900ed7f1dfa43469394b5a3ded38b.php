...
<form id="stepForm" action="<?php echo e(route('admin.products.create.step3.process')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.products.create._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/products/create/step3.blade.php ENDPATH**/ ?>