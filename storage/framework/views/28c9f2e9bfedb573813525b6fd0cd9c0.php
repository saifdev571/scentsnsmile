        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalBlogs); ?></p>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($activeBlogs); ?></p>
            ...
            <div class="bg-purple-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($blogs->sum('views')); ?></p>
                ...
                <table id="blogsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                            data-status="<?php echo e($blog->is_active ? '1' : '0'); ?>"
                            data-id="<?php echo e($blog->id); ?>">
                            
                            <!-- Checkbox -->
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" value="<?php echo e($blog->id); ?>">
                            </td>

                            <!-- ID -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($blog->id); ?></span>
                            </td>

                            <!-- Image -->
                            <td class="px-4 py-4 text-center">
                                <img src="<?php echo e($blog->featured_image_url); ?>" alt="<?php echo e($blog->title); ?>" class="w-16 h-16 rounded-lg object-cover mx-auto border-2 border-gray-200">
                            </td>

                            <!-- Title -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900 group-hover:text-blue-700"><?php echo e($blog->title); ?></p>
                                <p class="text-xs text-gray-500 mt-1"><?php echo e($blog->slug); ?></p>
                            </td>

                            <!-- Author -->
                            <td class="px-4 py-4">
                                <span class="text-sm text-gray-700"><?php echo e($blog->author ?? 'N/A'); ?></span>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($blog->id); ?>" data-field="is_featured" <?php echo e($blog->is_featured ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($blog->id); ?>" data-field="is_active" <?php echo e($blog->is_active ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                            ...
                                            data-slug="<?php echo e($blog->slug); ?>"
                                            data-excerpt="<?php echo e($blog->excerpt); ?>"
                                            data-content="<?php echo e($blog->content); ?>"
                                            data-featured-image="<?php echo e($blog->featured_image); ?>"
                                            data-author="<?php echo e($blog->author); ?>"
                                            data-published-at="<?php echo e($blog->published_at); ?>"
                                            data-is-featured="<?php echo e($blog->is_featured ? 'true' : 'false'); ?>"
                                            data-is-active="<?php echo e($blog->is_active ? 'true' : 'false'); ?>">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600">1</span> to <span class="font-bold text-blue-600"><?php echo e(count($blogs)); ?></span> of <span class="font-bold text-blue-600"><?php echo e(count($blogs)); ?></span> entries
                    </div>
...
<?php echo $__env->make('admin.blogs.modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('admin.blogs.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/blogs/index.blade.php ENDPATH**/ ?>