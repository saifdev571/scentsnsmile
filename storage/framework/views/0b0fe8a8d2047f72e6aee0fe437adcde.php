        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalAdmins); ?></p>
            ...
            <div class="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($activeAdmins); ?></p>
            ...
            <div class="bg-gradient-to-br from-orange-600 to-orange-700 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($inactiveAdmins); ?></p>
            ...
            <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalRoles); ?></p>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-200"
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($admin->id); ?></span>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center space-x-3">
                                    <?php if($admin->avatar): ?>
                                        <img src="<?php echo e(asset('storage/' . $admin->avatar)); ?>" alt="Avatar" class="w-10 h-10 rounded-full border-2 border-purple-200">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <p class="text-sm font-bold text-gray-900 group-hover:text-purple-700"><?php echo e($admin->name); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($admin->email); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold 
                                    <?php if($admin->role->slug === 'super-admin'): ?> bg-gradient-to-r from-red-100 to-pink-100 text-red-700 border border-red-300
                                    <?php elseif($admin->role->slug === 'manager'): ?> bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 border border-blue-300
                                    <?php else: ?> bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-300
                                    <?php endif; ?>">
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($admin->id); ?>" <?php echo e($admin->status === 'active' ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="text-xs text-gray-600">
                                    <?php echo e($admin->last_login ? $admin->last_login->format('M d, Y H:i') : 'Never'); ?>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-purple-600"><?php echo e($admins->firstItem() ?? 0); ?></span> to <span class="font-bold text-purple-600"><?php echo e($admins->lastItem() ?? 0); ?></span> of <span class="font-bold text-purple-600"><?php echo e($admins->total()); ?></span> entries
                    </div>
                    <div>
