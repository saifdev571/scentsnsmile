...
<body class="pattern-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div
            class="absolute top-20 left-10 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse">
        </div>
        <div
            class="absolute top-40 right-10 w-72 h-72 bg-indigo-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-2000">
        </div>
        <div
            class="absolute -bottom-8 left-1/2 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-4000">
        </div>
    </div>
            ...
            <div class="gradient-bg p-12 text-white hidden lg:flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-center space-x-3 mb-8">
                        <img src="<?php echo e(asset('images/logo-white.png')); ?>" alt="<?php echo e(config('app.name', 'Scents N Smile')); ?>"
                            class="h-12 w-auto">
            ...
            <div class="p-12 lg:p-16 flex flex-col justify-center">
                ...
                <div class="lg:hidden flex items-center space-x-3 mb-8">
                    <img src="<?php echo e(asset('images/logo-transparent.png')); ?>"
                        alt="<?php echo e(config('app.name', 'Scents N Smile')); ?>" class="h-10 w-auto">
...
</html><?php /**PATH /Applications/XAMPP/htdocs/scentnsmile/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>