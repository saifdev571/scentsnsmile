<?php $__env->startSection('title', 'Coupons Management'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalCoupons); ?></p>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($activeCoupons); ?></p>
            ...
            <div class="bg-red-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($expiredCoupons); ?></p>
            ...
            <div class="bg-blue-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalUsage); ?></p>
                ...
                <table id="couponsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-orange-50 hover:to-amber-50 transition-all duration-200"
                            data-status="<?php echo e($coupon->is_active ? '1' : '0'); ?>"
                            data-id="<?php echo e($coupon->id); ?>">
                            
                            <!-- Checkbox -->
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-orange-600 border-gray-300 rounded focus:ring-2 focus:ring-orange-500" value="<?php echo e($coupon->id); ?>">
                            </td>

                            <!-- ID -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($coupon->id); ?></span>
                            </td>

                            <!-- Code -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900 group-hover:text-orange-700 font-mono"><?php echo e($coupon->code); ?></p>
                            </td>

                            <!-- Discount Type -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold 
                                    <?php echo e($coupon->discount_type === 'percentage' ? 'bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 border border-blue-300' : 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-300'); ?>">
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($coupon->id); ?>" data-field="is_active" <?php echo e($coupon->is_active ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                            ...
                                            data-discount-value="<?php echo e($coupon->discount_value); ?>"
                                            data-min-purchase="<?php echo e($coupon->min_purchase); ?>"
                                            data-max-discount="<?php echo e($coupon->max_discount); ?>"
                                            data-start-date="<?php echo e($coupon->start_date ? $coupon->start_date->format('Y-m-d') : ''); ?>"
                                            data-end-date="<?php echo e($coupon->end_date ? $coupon->end_date->format('Y-m-d') : ''); ?>"
                                            data-usage-limit="<?php echo e($coupon->usage_limit); ?>"
                                            data-is-active="<?php echo e($coupon->is_active ? 'true' : 'false'); ?>">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-orange-600">1</span> to <span class="font-bold text-orange-600"><?php echo e(count($coupons)); ?></span> of <span class="font-bold text-orange-600"><?php echo e(count($coupons)); ?></span> entries
                    </div>
    ...
    <div id="couponModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                <form id="couponForm" method="POST" action="<?php echo e(route('admin.coupons.store')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <?php echo $__env->make('admin.coupons.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/htdocs/scentnsmile/resources/views/admin/coupons/index.blade.php ENDPATH**/ ?>