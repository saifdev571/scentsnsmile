...
<?php if(isset($headerPromotion) && $headerPromotion && !request()->routeIs('home')): ?>
    <div class="fixed top-0 left-0 right-0 z-[51] px-2 pt-1.5">
        <div class="text-white rounded-full mx-auto max-w-7xl" style="background-color: <?php echo e($headerPromotion->badge_color ?? '#000000'); ?>">
            <div class="px-4 py-1.5">
                <div class="flex items-center justify-between text-xs">
                    <!-- Left - Sale Name -->
                    <div class="flex items-center gap-2">
                        <span class="font-black uppercase tracking-wider text-sm"><?php echo e($headerPromotion->banner_title ?? $headerPromotion->name); ?></span>
                    </div>
                    ...
                    <div class="hidden md:flex items-center gap-4 lg:gap-6">
                        ...
                        <div class="flex items-center gap-1.5">
                            <span class="bg-white rounded-full w-5 h-5 flex items-center justify-center font-bold text-[10px]" style="color: <?php echo e($headerPromotion->badge_color ?? '#000000'); ?>"><?php echo e($headerPromotion->min_items); ?></span>
                        ...
                        <div class="flex items-center gap-1.5">
                            <span class="bg-white rounded-full w-5 h-5 flex items-center justify-center font-bold text-[10px]" style="color: <?php echo e($headerPromotion->badge_color ?? '#000000'); ?>"><?php echo e($headerPromotion->free_shipping_min_items ?? 3); ?></span>
...
<div id="cartSidebar" class="fixed inset-0 z-[70] hidden">
    ...
    <div id="cartPanel" class="absolute right-0 top-0 h-full w-full sm:w-[340px] bg-white shadow-2xl transform translate-x-full transition-transform duration-300 flex flex-col">
        ...
        <div class="text-white p-2.5 m-2.5 rounded-lg" style="background-color: <?php echo e($activePromotion->badge_color ?? '#000000'); ?>" id="cartPromoBanner"
             data-promo-id="<?php echo e($activePromotion->id); ?>"
             data-min-items="<?php echo e($activePromotion->min_items); ?>"
            ...
            <div class="flex items-center gap-1.5 mb-2">
                <h3 class="text-sm font-black uppercase tracking-wide"><?php echo e($activePromotion->banner_title ?? $activePromotion->name); ?></h3>
            ...
            <div class="mb-2.5">
                <div class="flex items-center justify-between mb-1">
                    <span class="text-[11px]"><?php echo e($activePromotion->min_items); ?>+ items <?php echo e($activePromotion->discount_text); ?></span>
                </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-1">
                    <span class="text-[11px]"><?php echo e($activePromotion->free_shipping_min_items ?? 3); ?>+ items Free shipping</span>
        ...
        <div class="bg-gray-800 text-white p-2.5 m-2.5 rounded-lg" id="cartPromoBanner"
             ...
             data-free-shipping-threshold="<?php echo e($settings['free_shipping_threshold'] ?? 999); ?>"
             data-shipping-charge="<?php echo e($settings['shipping_charge'] ?? 99); ?>"
             data-cart-label="Discount">
            <div class="text-center py-2">
                <?php if(($settings['free_shipping_threshold'] ?? 999) > 0): ?>
                    <p class="text-sm">Free shipping on orders above ₹<?php echo e(number_format($settings['free_shipping_threshold'] ?? 999, 0)); ?></p>
                <?php else: ?>
            ...
            <div class="mb-3">
                <div class="bg-[#f5e6d3] rounded-xl px-4 py-3 flex items-center gap-3 mb-3">
                    <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center">
                        <span class="text-lg font-bold" style="color: <?php echo e($activePromotion->badge_color ?? '#ef4444'); ?>">1</span>
                    </div>
            ...
            <div class="mb-3">
                <div class="border-2 border-red-400 rounded-xl overflow-hidden">
                    ...
                    <div class="bg-[#f5e6d3] px-4 py-3 flex items-center gap-3">
                        <div class="w-8 h-8 rounded-full bg-white flex items-center justify-center">
                            <span class="text-lg font-bold" style="color: <?php echo e($activePromotion->badge_color ?? '#ef4444'); ?>">2</span>
                        </div>
                    ...
                    <div class="bg-white px-4 py-4 space-y-3">
                        ...
                        <div class="flex justify-between text-base" style="color: <?php echo e($activePromotion->badge_color ?? '#ef4444'); ?>">
                            <span class="font-semibold" id="cartDiscountLabel"><?php echo e($activePromotion->cart_label ?? 'Sale discount'); ?>:</span>
        ...
        <div class="p-3 border-t bg-white">
            ...
            <a href="<?php echo e(route('checkout.index')); ?>" id="checkoutBtn" class="block w-full bg-red-500 hover:bg-red-600 text-white font-bold py-3 rounded-full text-base transition-colors text-center opacity-50 pointer-events-none">
                GO TO CHECKOUT
            </a>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="<?php echo e(route('search', ['q' => 'floral'])); ?>" class="px-4 py-2 rounded-full text-sm font-medium transition hover:opacity-80"
                                style="background-color: #FFB6C1; color: #000;">Floral</a>
                            <a href="<?php echo e(route('search', ['q' => 'vanilla'])); ?>" class="px-4 py-2 rounded-full text-sm font-medium transition hover:opacity-80"
                                style="background-color: #FFD700; color: #000;">Vanilla</a>
                            <a href="<?php echo e(route('search', ['q' => 'gourmand'])); ?>" class="px-4 py-2 rounded-full text-sm font-medium transition hover:opacity-80"
                                style="background-color: #FF8C69; color: #000;">Gourmand</a>
                            <a href="<?php echo e(route('search', ['q' => 'fresh'])); ?>" class="px-4 py-2 rounded-full text-sm font-medium transition hover:opacity-80"
                                style="background-color: #98FB98; color: #000;">Fresh</a>
                            <a href="<?php echo e(route('search', ['q' => 'woody'])); ?>" class="px-4 py-2 rounded-full text-sm font-medium transition hover:opacity-80"
                                style="background-color: #DEB887; color: #000;">Woody</a>
                            <a href="<?php echo e(route('search', ['q' => 'citrus'])); ?>" class="px-4 py-2 rounded-full text-sm font-medium transition hover:opacity-80"
