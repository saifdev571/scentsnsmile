...
<?php $__env->startSection('title', 'Moments Management'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-blue-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalMoments); ?></p>
            ...
            <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                    ...
                    <div class="text-white">
                        <p class="text-4xl font-black mb-1"><?php echo e($activeMoments); ?></p>
            ...
            <div class="bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                    ...
                    <div class="text-white">
                        <p class="text-4xl font-black mb-1"><?php echo e($featuredMoments); ?></p>
            ...
            <div class="overflow-x-auto">
                <table id="momentsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $moments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                            data-status="<?php echo e($moment->is_active ? '1' : '0'); ?>"
                            data-featured="<?php echo e($moment->is_featured ? '1' : '0'); ?>"
                            data-navbar="<?php echo e($moment->show_in_navbar ? '1' : '0'); ?>"
                            data-homepage="<?php echo e($moment->show_in_homepage ? '1' : '0'); ?>">
                            
                            <!-- Checkbox -->
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" value="<?php echo e($moment->id); ?>">
                            </td>

                            <!-- ID -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($moment->id); ?></span>
                            </td>
                                ...
                                <?php if($moment->hasImageKitImage()): ?>
                                    <div class="flex justify-center">
                                        <div class="relative group/img">
                                            <img src="<?php echo e($moment->getListImageUrl()); ?>" alt="<?php echo e($moment->name); ?>" class="w-16 h-16 rounded-xl object-cover shadow-md border-2 border-gray-200 group-hover/img:border-blue-400 transition-all">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-start space-x-3">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center space-x-2">
                                            <p class="text-sm font-bold text-gray-900 truncate group-hover:text-blue-700"><?php echo e($moment->name); ?></p>
                                            <?php if($moment->is_featured): ?>
                                        ...
                                        <p class="text-xs text-gray-500 font-mono mt-1"><?php echo e($moment->slug); ?></p>
                                        <?php if($moment->description): ?>
                                            <p class="text-xs text-gray-600 mt-1 line-clamp-2"><?php echo e(Str::limit($moment->description, 80)); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center justify-center w-10 h-10 rounded-xl text-sm font-black bg-gradient-to-br from-indigo-100 to-purple-100 text-indigo-700 border-2 border-indigo-200">
                                    <?php echo e($moment->products()->count()); ?>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer feature-toggle" data-id="<?php echo e($moment->id); ?>" data-field="is_active" <?php echo e($moment->is_active ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer feature-toggle" data-id="<?php echo e($moment->id); ?>" data-field="is_featured" <?php echo e($moment->is_featured ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer feature-toggle" data-id="<?php echo e($moment->id); ?>" data-field="show_in_navbar" <?php echo e($moment->show_in_navbar ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer feature-toggle" data-id="<?php echo e($moment->id); ?>" data-field="show_in_homepage" <?php echo e($moment->show_in_homepage ? 'checked' : ''); ?>>
                                    <div class="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-green-400 peer-checked:to-emerald-500"></div>
                                </label>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                            title="Edit Moment"
                                            data-id="<?php echo e($moment->id); ?>"
                                            data-name="<?php echo e($moment->name); ?>"
                                            data-slug="<?php echo e($moment->slug); ?>"
                                            data-description="<?php echo e($moment->description); ?>"
                                            data-sort-order="<?php echo e($moment->sort_order); ?>"
                                            data-is-active="<?php echo e($moment->is_active ? 'true' : 'false'); ?>"
                                            data-is-featured="<?php echo e($moment->is_featured ? 'true' : 'false'); ?>"
                                            data-show-in-navbar="<?php echo e($moment->show_in_navbar ? 'true' : 'false'); ?>"
                                            data-show-in-homepage="<?php echo e($moment->show_in_homepage ? 'true' : 'false'); ?>"
                                            data-image-url="<?php echo e($moment->getImageUrl()); ?>">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600">1</span> to <span class="font-bold text-blue-600"><?php echo e(count($moments)); ?></span> of <span class="font-bold text-blue-600"><?php echo e(count($moments)); ?></span> entries
                    </div>
    ...
    <div id="momentModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                <form id="momentForm" method="POST" action="<?php echo e(route('admin.moments.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            document.getElementById('momentForm').action = '<?php echo e(route('admin.moments.store')); ?>';
    ...
    <?php echo $__env->make('admin.moments.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/admin/moments/index.blade.php ENDPATH**/ ?>