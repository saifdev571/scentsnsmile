        ...
        <div class="p-5">
            ...
            <div class="border-b border-gray-100">
                ...
                <div id="genderFilter" class="pb-4 space-y-3">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        <input type="checkbox" name="gender[]" value="<?php echo e($gender->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]" <?php echo e($type === 'gender' && $item->id === $gender->id ? 'checked' : ''); ?>>
            ...
            <div class="border-b border-gray-100">
                ...
                <div id="scentFilter" class="pb-4 space-y-3">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        ...
                        <?php else: ?>
                        <span class="w-4 h-4 rounded-full" style="background-color: <?php echo e($tag->color ?? '#F27F6E'); ?>"></span>
                        <?php endif; ?>
                        <input type="checkbox" name="tag[]" value="<?php echo e($tag->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]" <?php echo e($type === 'tag' && $item->id === $tag->id ? 'checked' : ''); ?>>
            ...
            <div class="border-b border-gray-100">
                ...
                <div id="scentFamiliesFilter" class="pb-4 space-y-3">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        ...
                        <?php endif; ?>
                        <input type="checkbox" name="scent_family[]" value="<?php echo e($scentFamily->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]">
            ...
            <div class="border-b border-gray-100">
                ...
                <div id="collectionsFilter" class="pb-4 space-y-3">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        <input type="checkbox" name="collection[]" value="<?php echo e($collection->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]" <?php echo e($type === 'collection' && $item->id === $collection->id ? 'checked' : ''); ?>>
            ...
            <div class="border-b border-gray-100">
                ...
                <div id="highlightNotesFilter" class="pb-4 space-y-3">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        ...
                        <img src="<?php echo e($note->imagekit_thumbnail_url ?? $note->imagekit_url); ?>" alt="<?php echo e($note->name); ?>" class="w-6 h-6 rounded object-cover">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <input type="checkbox" name="highlight_note[]" value="<?php echo e($note->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]">
            ...
            <div class="flex gap-4 overflow-x-auto pb-2 hide-scrollbar pl-4">
                ...
                <a href="<?php echo e(route('collections.show', 'all')); ?>" 
                   class="flex-shrink-0 w-[320px] h-24 rounded-[28px] flex items-center justify-between px-8 relative overflow-hidden transition-transform hover:scale-[1.02] <?php echo e($slug === 'all' ? 'bg-[#F27F6E]' : 'bg-[#F4ECDD]'); ?>">
                    <div class="flex flex-col justify-center z-10">
                        <span class="<?php echo e($slug === 'all' ? 'text-white' : 'text-gray-900'); ?> text-lg font-bold uppercase tracking-wide">All Perfumes</span>
                        <span class="<?php echo e($slug === 'all' ? 'text-white/90' : 'text-gray-600'); ?> text-sm font-medium uppercase tracking-wider">Farewell Sale</span>
                    </div>
                ...
                <a href="<?php echo e(route('collections.show', 'bestsellers')); ?>" 
                   class="flex-shrink-0 w-[280px] h-24 rounded-[28px] flex items-center justify-between px-8 relative overflow-hidden transition-transform hover:scale-[1.02] <?php echo e($slug === 'bestsellers' ? 'bg-[#F27F6E]' : 'bg-[#F4ECDD]'); ?>">
                    <div class="flex flex-col justify-center z-10">
                        <span class="<?php echo e($slug === 'bestsellers' ? 'text-white' : 'text-gray-900'); ?> text-lg font-bold uppercase tracking-wide">Bestsellers</span>
                    </div>
                ...
                <a href="<?php echo e(route('collections.show', 'new-arrivals')); ?>" 
                   class="flex-shrink-0 w-[280px] h-24 rounded-[28px] flex items-center justify-between px-8 relative overflow-hidden transition-transform hover:scale-[1.02] <?php echo e($slug === 'new-arrivals' ? 'bg-[#F27F6E]' : 'bg-[#F4ECDD]'); ?>">
                    <div class="flex flex-col justify-center z-10">
                        <span class="<?php echo e($slug === 'new-arrivals' ? 'text-white' : 'text-gray-900'); ?> text-lg font-bold uppercase tracking-wide">New Arrivals</span>
                    </div>
                    <div class="absolute right-4 top-1/2 -translate-y-1/2">
                ...
                <a href="<?php echo e(route('collections.show', $gender->slug)); ?>" 
                   class="flex-shrink-0 w-[240px] h-24 rounded-[28px] flex items-center justify-between px-8 relative overflow-hidden transition-transform hover:scale-[1.02] <?php echo e($type === 'gender' && $item->id === $gender->id ? 'bg-[#F27F6E]' : 'bg-[#F4ECDD]'); ?>">
                    <div class="flex flex-col justify-center z-10">
                        <span class="<?php echo e($type === 'gender' && $item->id === $gender->id ? 'text-white' : 'text-gray-900'); ?> text-lg font-bold uppercase tracking-wide"><?php echo e($gender->name); ?></span>
                    </div>
                    <?php if($gender->imagekit_thumbnail_url || $gender->imagekit_url): ?>
                    <div class="absolute right-4 top-1/2 -translate-y-1/2">
                        <img src="<?php echo e($gender->imagekit_thumbnail_url ?? $gender->imagekit_url); ?>" alt="<?php echo e($gender->name); ?>" class="h-16 w-auto object-contain drop-shadow-lg">
                    </div>
                    <?php endif; ?>
                </a>
                ...
                <div class="relative">
                    ...
                    <div id="genderPillDropdown" class="hidden absolute top-full mt-2 left-0 bg-white rounded-2xl shadow-xl border border-gray-200 p-4 min-w-[200px] z-50">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group py-2 hover:bg-gray-50 rounded-lg px-2">
                            <input type="checkbox" name="gender_pill[]" value="<?php echo e($gender->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]" <?php echo e($type === 'gender' && $item->id === $gender->id ? 'checked' : ''); ?>>
                            <span class="text-sm text-gray-700 group-hover:text-gray-900"><?php echo e($gender->name); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div id="scentFamilyPillDropdown" class="hidden absolute top-full mt-2 left-0 bg-white rounded-2xl shadow-xl border border-gray-200 p-4 min-w-[200px] z-50">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group py-2 hover:bg-gray-50 rounded-lg px-2">
                            ...
                            <span class="text-base"><?php echo e($scentFamily->icon); ?></span>
                            <?php endif; ?>
                            <input type="checkbox" name="scent_family_pill[]" value="<?php echo e($scentFamily->id); ?>" class="w-4 h-4 rounded border-gray-300 text-[#F27F6E] focus:ring-[#F27F6E]">
                            <span class="text-sm text-gray-700 group-hover:text-gray-900"><?php echo e($scentFamily->name); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="px-4">
            ...
            <div class="flex items-center justify-between mb-6">
                <p class="text-gray-600 text-sm">
                    ...
                    <span id="productCount" class="font-semibold text-gray-900 ml-2"><?php echo e($products->total()); ?> Products</span>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SCENTS N SMILE\resources\views/collection-show.blade.php ENDPATH**/ ?>