...
@section('title', 'Pre-Built Bundles - Scents N Smile')
...
<section class="py-4 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between items-center">
            ...
            <span class="text-sm text-gray-600">{{ count($bundles) }} Items</span>
        </div>
    </div>
</section>
...
<section class="py-8 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('product.demo') }}" class="group relative block">
                <!-- Wishlist Button -->
                ...
                <!-- Bundle Info -->
                <div class="space-y-2">
                    <h3 class="font-bold text-base leading-tight group-hover:text-red-500 transition-colors">{{ $bundle['name'] }}</h3>
                    
                    <!-- Price -->
                    <div class="flex items-center gap-2">
                        <span class="text-lg font-bold">Rs. {{ number_format($bundle['price'] / 100, 0) }}</span>
                        <span class="text-sm text-gray-500 line-through">Rs. {{ number_format($bundle['original_price'] / 100, 0) }}</span>
                    </div>
