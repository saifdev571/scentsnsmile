...
@section('title', 'Order Confirmed - Scents N Smile')
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="font-semibold text-sm text-gray-900 line-clamp-2">{{ $item->product_name }}</h4>
                            <p class="text-gray-500 text-xs mt-1">Qty: {{ $item->quantity }}</p>
                            <p class="font-bold text-sm mt-1">₹{{ number_format($item->total, 0) }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
                ...
                <div class="flex items-center gap-3 mb-3">
                    <span class="text-2xl">{{ $order->payment_method === 'cod' ? '💵' : '💳' }}</span>
                    <div>
                ...
                <div class="flex items-center gap-2">
                    <span class="w-2 h-2 rounded-full {{ $order->payment_status === 'paid' ? 'bg-green-500' : 'bg-yellow-500' }}"></span>
                    <span class="text-sm capitalize {{ $order->payment_status === 'paid' ? 'text-green-600' : 'text-yellow-600' }}">
