                        ...
                        <div class="bg-[#f5f5f0] rounded-2xl overflow-hidden aspect-square relative w-full">
                            ...
                            @if(count($allImages) > 1)
                                <div class="absolute right-4 bottom-4 flex gap-2">
                                    ...
                                    <button onclick="nextProductImage()"
                                        class="w-12 h-12 bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full flex items-center justify-center shadow-lg transition-all duration-200">
                                        <svg class="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                                d="M9 5l7 7-7 7" />
                ...
                <div class="space-y-4 lg:col-span-5">
                    ...
                    <div class="border-t border-gray-200 pt-4">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div class="bg-white rounded-lg p-2 shadow-sm border border-gray-200">
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/American_Express_logo_%282018%29.svg/200px-American_Express_logo_%282018%29.svg.png"
                                        alt="American Express" class="h-5 object-contain">
                                </div>
                                <div class="bg-white rounded-lg p-2 shadow-sm border border-gray-200">
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Apple_Pay_logo.svg/200px-Apple_Pay_logo.svg.png"
                                        alt="Apple Pay" class="h-5 object-contain">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-[#f5ecd7] rounded-lg p-3 text-[#5c4033] border border-[#e8d4a8]">
                            ...
                            <p class="text-xs leading-relaxed">
                                Order within the next <span id="shippingCountdown"
                                    class="font-bold text-[#e8a598]">--</span> for dispatch today
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-4">
                        ...
                        <div class="relative flex items-center gap-2">
                            <!-- Left Arrow -->
                            <button onclick="slideTabsLeft()" id="tabSlideLeft"
                                class="flex-shrink-0 w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-all duration-200 hidden">
                                ...
                                <div class="flex gap-3 transition-transform duration-300" id="tabSlider"
                                    ...
                                    @php
                                        ...
                                        if ($product->about_scent)
                                            $firstTab = 'aboutScent';
                                        elseif ($product->fragrance_notes || ($product->highlightNotes && $product->highlightNotes->count() > 0))
                                            $firstTab = 'fragranceNotes';
                                        elseif ($product->ingredients_details)
                                    ...
                                    @if($product->about_scent)
                                        <button onclick="toggleProductTab('aboutScent')" id="aboutScentProductTab"
                                            ...
                                            <span>About</span>
                                            <svg class="w-4 h-4 tab-arrow transition-transform duration-200" fill="none"
                                    ...
                                    @if($product->fragrance_notes || ($product->highlightNotes && $product->highlightNotes->count() > 0))
                                        <button onclick="toggleProductTab('fragranceNotes')" id="fragranceNotesProductTab"
                                            ...
                                            <span>Notes</span>
                                            <svg class="w-4 h-4 tab-arrow transition-transform duration-200"
                                                style="transform: rotate(180deg);" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 9l-7 7-7-7" />
                                            </svg>
                            ...
                            <!-- Right Arrow -->
                            <button onclick="slideTabsRight()" id="tabSlideRight"
                                class="flex-shrink-0 w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-all duration-200">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="bg-white rounded-2xl shadow-sm">
                ...
                <div class="border-b border-gray-200 p-6">
                    <div class="flex items-start justify-between">
                        ...
                        <button onclick="toggleReviewForm()"
                            class="bg-white border-2 border-gray-300 hover:border-[#e8a598] text-gray-700 font-medium px-6 py-2 rounded-lg transition-colors flex items-center gap-2">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-3" data-rating="5">
                                <button onclick="filterByRating(5)"
                                    class="text-sm text-gray-700 hover:text-[#e8a598] transition w-8">5 ★</button>
                            ...
                            <div class="flex items-center gap-3" data-rating="4">
                                <button onclick="filterByRating(4)"
                                    class="text-sm text-gray-700 hover:text-[#e8a598] transition w-8">4 ★</button>
                                <div class="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-green-400 transition-all duration-300" style="width: 0%"
                                        id="rating4Bar"></div>
                                </div>
                            ...
                            <div class="flex items-center gap-3" data-rating="3">
                                <button onclick="filterByRating(3)"
                                    class="text-sm text-gray-700 hover:text-[#e8a598] transition w-8">3 ★</button>
                                <div class="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-yellow-400 transition-all duration-300" style="width: 0%"
                                        id="rating3Bar"></div>
                                </div>
                            ...
                            <div class="flex items-center gap-3" data-rating="2">
                                <button onclick="filterByRating(2)"
                                    class="text-sm text-gray-700 hover:text-[#e8a598] transition w-8">2 ★</button>
                                <div class="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-orange-400 transition-all duration-300" style="width: 0%"
                                        id="rating2Bar"></div>
                                </div>
                            ...
                            <div class="flex items-center gap-3" data-rating="1">
                                <button onclick="filterByRating(1)"
                                    class="text-sm text-gray-700 hover:text-[#e8a598] transition w-8">1 ★</button>
                                <div class="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-red-500 transition-all duration-300" style="width: 0%"
                                        id="rating1Bar"></div>
                                </div>
                        ...
                        <form id="reviewForm" onsubmit="submitReview(event)">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center gap-2" id="starRating">
                                    <button type="button" onclick="setRating(1)"
                                        class="star-btn text-3xl text-gray-300 hover:text-[#e8a598] transition">★</button>
                            ...
                            <div class="grid md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div id="nameField">
                                    ...
                                    <input type="text" id="reviewName" name="name"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e8a598] focus:border-transparent"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="reviewTitle" name="title"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e8a598] focus:border-transparent"
                                    placeholder="Sum up your experience" maxlength="255">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="reviewComment" name="comment" rows="4"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e8a598] focus:border-transparent resize-none"
                                ...
                                <div class="flex items-center justify-between mt-1">
                                    <p class="text-red-500 text-xs hidden" id="commentError">Review must be at least 10
                                        characters</p>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#e8a598] transition cursor-pointer"
                                ...
                                <input type="file" id="imageInput" accept="image/jpeg,image/jpg,image/png,image/webp"
                                    multiple class="hidden" onchange="handleImageSelect(event)">
                            ...
                            <div class="flex items-center gap-3">
                                <button type="submit" id="submitReviewBtn"
                                    class="bg-[#e8a598] hover:bg-[#d4948a] text-white font-bold px-6 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                    Submit Review
                                </button>
                ...
                <div class="border-b border-gray-200 p-4 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <select id="ratingFilter" onchange="applyFilters()"
                            class="px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#e8a598]">
                ...
                <div id="loadMoreContainer" class="text-center p-6 hidden">
                    <button onclick="loadMoreReviews()" id="loadMoreBtn"
                        class="text-[#e8a598] hover:text-[#d4948a] font-medium text-sm">
                        View More Reviews ▼
                    </button>
                </div>
            </div>
...
@push('scripts')
    ...
    <div id="scentIntensityModal"
        class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div
            class="bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
            <!-- Close Button -->
            <button onclick="closeScentIntensityModal()"
                class="absolute top-4 right-4 text-gray-700 hover:text-gray-900 text-2xl font-bold z-10">
                Close
            </button>
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1541643600914-78b084683601?w=400&h=400&fit=crop"
                            alt="Perfume Bottles" class="w-full rounded-2xl shadow-lg">
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-md">
                            <p class="text-gray-700 leading-relaxed">
                                ...
                                <span class="text-orange-500 font-semibold">intensity</span> of each fragrance based on both
                                the
                                <span class="font-semibold">projection</span> (i.e. how faint or strong the scent is) and
                                <span class="font-semibold">longevity</span> (i.e. how long the scent is detectable on the
                                skin).
                            </p>
                        </div>
