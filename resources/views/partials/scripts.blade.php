<script>
    ...
    window.renderCart = function(data) {
        ...
        const defaultShipping = parseFloat(promoBanner?.dataset.shippingCharge) || {{ $settings['shipping_charge'] ?? 99 }};
        const freeShippingThreshold = parseFloat(promoBanner?.dataset.freeShippingThreshold) || {{ $settings['free_shipping_threshold'] ?? 999 }};
