        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ $settings['instagram'] }}" target="_blank" class="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-[#e8a598] hover:border-[#e8a598] hover:text-white transition-all group">
                    ...
                    <a href="{{ $settings['facebook'] }}" target="_blank" class="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-[#e8a598] hover:border-[#e8a598] hover:text-white transition-all group">
                        <svg class="w-4 h-4 text-gray-600 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['twitter'] }}" target="_blank" class="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-[#e8a598] hover:border-[#e8a598] hover:text-white transition-all group">
                        <svg class="w-4 h-4 text-gray-600 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['pinterest'] }}" target="_blank" class="w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-[#e8a598] hover:border-[#e8a598] hover:text-white transition-all group">
                        <svg class="w-4 h-4 text-gray-600 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('collections') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">All Products</a></li>
                    <li><a href="{{ route('collections.show', 'bestsellers') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Best Sellers</a></li>
                    <li><a href="{{ route('collections.show', 'new-arrivals') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">New Arrivals</a></li>
                    <li><a href="{{ route('bundle.index') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Bundle</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('about') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">About Us</a></li>
                    <li><a href="{{ route('contact') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Contact Us</a></li>
                    <li><a href="{{ route('faq') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">FAQ</a></li>
                    <li><a href="{{ route('privacy-policy') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Privacy Policy</a></li>
                    <li><a href="{{ route('return-refund') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Return & Refund</a></li>
                    <li><a href="{{ route('shipping-policy') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Shipping Policy</a></li>
                    <li><a href="{{ route('tracking.index') }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">Track Order</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-sm text-gray-600">{{ $settings['address'] }}</span>
                    </li>
                    @endif
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:{{ $settings['phone'] }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">{{ $settings['phone'] }}</a>
                    </li>
                    @endif
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:{{ $settings['email'] }}" class="text-sm text-gray-600 hover:text-[#e8a598] transition-colors">{{ $settings['email'] }}</a>
                    </li>
                    @endif
                </ul>
        ...
        <div class="border-t border-gray-200 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p class="text-sm text-gray-500 text-center md:text-left">
                    © {{ date('Y') }} <span class="font-semibold text-gray-700">{{ $settings['business_name'] ?? 'Scents N Smile' }}</span>. All Rights Reserved.
                </p>

                <!-- Links -->
                <div class="flex flex-wrap justify-center gap-4 text-sm">
                    <a href="{{ route('privacy-policy') }}" class="text-gray-500 hover:text-[#e8a598] transition-colors">Privacy Policy</a>
                    <span class="text-gray-300">|</span>
                    <a href="{{ route('return-refund') }}" class="text-gray-500 hover:text-[#e8a598] transition-colors">Return & Refund</a>
                    <span class="text-gray-300">|</span>
                    <a href="{{ route('terms-conditions') }}" class="text-gray-500 hover:text-[#e8a598] transition-colors">Terms & Conditions</a>
                    <span class="text-gray-300">|</span>
                    <a href="{{ route('faq') }}" class="text-gray-500 hover:text-[#e8a598] transition-colors">FAQ</a>
                </div>
            </div>
        </div>
    </div>
