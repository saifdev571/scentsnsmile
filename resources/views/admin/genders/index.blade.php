...
@section('title', 'Genders Management')
...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Genders Management</h1>
                        <p class="mt-1 text-sm text-gray-600">Manage product Genders with slugs</p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">{{ $totalGenders }}</p>
                    <p class="text-orange-100 text-sm font-medium">Total Genders</p>
                </div>
            </div>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">{{ $activeGenders }}</p>
                    <p class="text-emerald-100 text-sm font-medium">Active Genders</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1 ml-11">Manage all product Genders with slugs</p>
                    </div>
            ...
            <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Search Genders</label>
                        <div class="relative">
                            ...
                            <input type="text" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Search by name or slug...">
                        </div>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table id="gendersTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-slate-100 to-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-4 text-center w-32">
                                <span class="text-xs font-black text-gray-700 uppercase">Slug</span>
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                            data-status="{{ $gender->is_active ? '1' : '0' }}"
                            data-id="{{ $gender->id }}">
                            ...
                            <!-- Image -->
                            <td class="px-4 py-4 text-center">
                                @if($gender->hasImageKitImage())
                                    <div class="flex justify-center">
                                        <div class="relative group/img">
                                            <img src="{{ $gender->getListImageUrl() }}" alt="{{ $gender->name }}" class="w-16 h-16 rounded-xl object-cover shadow-md border-2 border-gray-200 group-hover/img:border-blue-400 transition-all">
                            ...
                            <!-- Name -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900 group-hover:text-blue-700">{{ $gender->name }}</p>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                            ...
                                            data-slug="{{ $gender->slug }}"
                                            data-description="{{ $gender->description ?? '' }}"
                                            data-sort-order="{{ $gender->sort_order }}"
                                            data-is-active="{{ $gender->is_active ? 'true' : 'false' }}"
                                            data-image-url="{{ $gender->getImageUrl() }}"
                                            ...
                                            data-main-image-url="{{ $gender->getMainImageUrl() }}"
                                            data-main-imagekit-file-id="{{ $gender->main_imagekit_file_id }}"
                                            data-main-imagekit-url="{{ $gender->main_imagekit_url }}"
                                            data-main-imagekit-thumbnail-url="{{ $gender->main_imagekit_thumbnail_url }}"
                                            data-main-imagekit-file-path="{{ $gender->main_imagekit_file_path }}">
                        ...
                        <tr id="emptyState">
                            <td colspan="8" class="px-6 py-20">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">No Genders Found</h3>
                                    <p class="text-gray-500 mb-6 max-w-md mx-auto">Start building your Gender system by creating your first Gender.</p>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600">1</span> to <span class="font-bold text-blue-600">{{ count($genders) }}</span> of <span class="font-bold text-blue-600">{{ count($genders) }}</span> entries
                    </div>
    ...
    <!-- Add/Edit Modal -->
    <div id="genderModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <form id="genderForm" method="POST" action="{{ route('admin.genders.store') }}">
                    @csrf
                    <input type="hidden" id="methodField" name="_method" value="POST">
                    <input type="hidden" id="genderId" name="gender_id">
                    
                    <!-- Modal Header -->
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <h3 id="modalTitle" class="text-xl font-bold text-gray-900">Add New Gender</h3>
                            </div>
                    ...
                    <div class="px-6 py-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Gender Name *</label>
                                <input type="text" name="name" id="name" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="e.g., Men">
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Slug</label>
                                <input type="text" name="slug" id="slug" maxlength="255" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-gray-50" placeholder="Auto-generated from name">
                                <p class="text-xs text-gray-500 mt-1">Auto-generated from name (editable)</p>
                            </div>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Description</label>
                            <textarea name="description" id="description" rows="3" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Enter gender description..."></textarea>
                        </div>

                        <!-- Thumb Image Upload Section -->
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Thumb Image</label>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition-all bg-gray-50">
                                ...
                                <div id="imagePreview" class="hidden">
                                    ...
                                    <button type="button" onclick="removeImage()" class="mt-3 text-red-600 hover:text-red-800 text-sm font-semibold">Remove Image</button>
                                </div>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Main Image</label>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-green-400 transition-all bg-gray-50">
                                ...
                                <input type="hidden" name="main_imagekit_file_id" id="mainImagekitFileId">
                                <input type="hidden" name="main_imagekit_url" id="mainImagekitUrl">
                                <input type="hidden" name="main_imagekit_thumbnail_url" id="mainImagekitThumbnailUrl">
                                <input type="hidden" name="main_imagekit_file_path" id="mainImagekitFilePath">
                                <input type="hidden" name="main_image_size" id="mainImageSize">
                                <input type="hidden" name="main_original_image_size" id="mainOriginalImageSize">
                                <input type="hidden" name="main_image_width" id="mainImageWidth">
                                <input type="hidden" name="main_image_height" id="mainImageHeight">
                                
                                <div id="mainUploadArea" class="cursor-pointer" onclick="document.getElementById('mainImageInput').click()">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                    <p class="mt-2 text-sm text-gray-600">Click to upload or drag and drop</p>
                                ...
                                <div id="mainImagePreview" class="hidden">
                                    <img id="mainPreviewImg" src="" alt="Preview" class="mx-auto max-h-48 rounded-lg">
                                    <button type="button" onclick="removeMainImage()" class="mt-3 text-red-600 hover:text-red-800 text-sm font-semibold">Remove Image</button>
                                </div>
                                
                                <div id="mainUploadProgress" class="hidden mt-4">
                                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                                        <div id="mainProgressBar" class="bg-green-600 h-2.5 rounded-full transition-all duration-300" style="width: 0%"></div>
                                    </div>
                                    <p id="mainProgressText" class="text-sm text-gray-600 mt-2">Uploading... 0%</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" id="submitBtn" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:scale-100">
                                ...
                                <span id="submitBtnText">Create Gender</span>
                            </button>
                        </div>
                    </div>
                </form>
