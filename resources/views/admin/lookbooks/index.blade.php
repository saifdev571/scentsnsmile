...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Lookbooks Management</h1>
                        <p class="mt-1 text-sm text-gray-600">Manage homepage lookbook banners</p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">{{ $totalLookbooks }}</p>
                    <p class="text-orange-100 text-sm font-medium">Total Lookbooks</p>
                </div>
            </div>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">{{ $activeLookbooks }}</p>
                    <p class="text-emerald-100 text-sm font-medium">Active Lookbooks</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1 ml-11">Manage all lookbook banners</p>
                    </div>
            ...
            <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Search Lookbooks</label>
                        <div class="relative">
                            ...
                            <input type="text" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Search by title...">
                        </div>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table id="lookbooksTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-slate-100 to-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-4 text-left min-w-[150px]">
                                <span class="text-xs font-black text-gray-700 uppercase">Subtitle</span>
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                            data-status="{{ $lookbook->is_active ? '1' : '0' }}"
                            data-id="{{ $lookbook->id }}">
                            ...
                            <!-- Title -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900 group-hover:text-blue-700">{{ $lookbook->title }}</p>
                            </td>

                            <!-- Image -->
                            <td class="px-4 py-4 text-center">
                                <img src="{{ $lookbook->image_url }}" alt="{{ $lookbook->title }}" class="w-16 h-16 object-cover rounded-lg mx-auto">
                            </td>

                            <!-- Subtitle -->
                            <td class="px-4 py-4">
                                <p class="text-sm text-gray-600">{{ $lookbook->subtitle ?: 'N/A' }}</p>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                            title="Edit Lookbook"
                                            data-id="{{ $lookbook->id }}"
                                            data-title="{{ $lookbook->title }}"
                                            data-subtitle="{{ $lookbook->subtitle }}"
                                            data-link="{{ $lookbook->link }}"
                        ...
                        <tr id="emptyState">
                            <td colspan="7" class="px-6 py-20">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">No lookbooks found</h3>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600">1</span> to <span class="font-bold text-blue-600">{{ count($lookbooks) }}</span> of <span class="font-bold text-blue-600">{{ count($lookbooks) }}</span> entries
                    </div>
    ...
    <!-- Add/Edit Modal -->
    <div id="lookbookModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <form id="lookbookForm" method="POST" action="{{ route('admin.lookbooks.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="methodField" name="_method" value="POST">
                    <input type="hidden" id="lookbookId" name="lookbook_id">
                    
                    <!-- Modal Header -->
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <h3 id="modalTitle" class="text-xl font-bold text-gray-900">Add New Lookbook</h3>
                            </div>
                    ...
                    <div class="px-6 py-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="title" id="title" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="e.g., LOOKBOOK 2021">
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Subtitle</label>
                                <input type="text" name="subtitle" id="subtitle" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="e.g., MAKE LOVE THIS LOOK">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" id="imageFile" accept="image/*" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                            <p class="text-xs text-gray-500 mt-1">Upload banner image (JPEG, PNG, WEBP - Max 5MB)</p>
                            <div id="imagePreview" class="mt-3 hidden">
                                <img id="previewImg" src="" alt="Preview" class="w-32 h-32 object-cover rounded-lg border-2 border-gray-300">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="url" name="link" id="link" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="https://example.com">
                        </div>

                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Position</label>
                                <select name="position" id="position" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                            ...
                            <div>
                                ...
                                <input type="number" name="sort_order" id="sortOrder" min="0" value="0" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                            </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" id="submitBtn" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:scale-100">
                                ...
                                <span id="submitBtnText">Create Lookbook</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    @include('admin.lookbooks.scripts')
@endsection
