    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button onclick="openAddModal()" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-purple-500 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-purple-600 hover:to-pink-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all" placeholder="Search by name...">
                    </div>
                </div>
                <div>
        ...
        <div class="overflow-x-auto">
            <table id="scentFamiliesTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="group hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-200" data-id="{{ $family->id }}" data-status="{{ $family->is_active ? '1' : '0' }}">
                        <td class="px-4 py-4 text-center">
                            <input type="checkbox" class="row-select w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500" value="{{ $family->id }}">
                        </td>
                        <td class="px-4 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#{{ $family->id }}</span>
                        </td>
                        <td class="px-4 py-4 text-center">
                            @if($family->imagekit_url)
                                <img src="{{ $family->imagekit_thumbnail_url ?? $family->imagekit_url }}" alt="{{ $family->name }}" class="w-12 h-12 rounded-lg object-cover mx-auto border-2 border-gray-200">
                            @else
                                <div class="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center mx-auto border-2 border-purple-200">
                        ...
                        <td class="px-4 py-4">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-sm font-bold bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 border border-purple-300">
                        ...
                        <td class="px-4 py-4 text-center">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold {{ $family->products_count > 0 ? 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-300' : 'bg-gradient-to-r from-gray-100 to-slate-100 text-gray-500 border border-gray-300' }}">
                                {{ $family->products_count ?? 0 }}
                            </span>
                        </td>
                        <td class="px-4 py-4 text-center">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer status-toggle" data-id="{{ $family->id }}" data-field="is_active" {{ $family->is_active ? 'checked' : '' }}>
                        ...
                        <td class="px-4 py-4 text-center">
                            <span class="text-xs text-gray-500 font-medium">{{ $family->created_at->format('M d, Y') }}</span>
                        </td>
                        <td class="px-4 py-4">
                    ...
                    <tr id="emptyState">
                        <td colspan="8" class="px-6 py-20">
                            <div class="text-center">
                                <div class="mx-auto flex items-center justify-center w-24 h-24 bg-gradient-to-br from-purple-100 to-pink-200 rounded-full mb-6">
                                ...
                                <button onclick="openAddModal()" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-purple-600 hover:to-pink-700 shadow-lg">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Add/Edit Modal -->
<div id="scentFamilyModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <form id="scentFamilyForm" method="POST" action="{{ route('admin.scent-families.store') }}">
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all" placeholder="Enter scent family name">
                    </div>

                    <!-- Image Upload -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Image</label>
                        <div id="uploadArea" class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-purple-400 transition-all cursor-pointer">
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
                    ...
                    <button type="submit" id="submitBtn" class="px-6 py-2.5 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold rounded-xl hover:from-purple-600 hover:to-pink-700 shadow-lg transition-all flex items-center">
