            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Soft -->
                        <div
                            class="relative flex flex-col p-4 bg-gray-50 border-2 border-gray-200 rounded-xl hover:border-purple-400 hover:bg-purple-50 transition-all duration-200 group has-[:checked]:border-purple-500 has-[:checked]:bg-purple-50">
                        ...
                        <div
                            ...
                            <label class="cursor-pointer block">
                                ...
                                <p class="text-sm text-gray-600 mt-2">Moderate projection with good presence. Noticeable
                                    without being overwhelming. Ideal for most occasions.</p>
                            </label>
                            <div class="mt-3 pt-3 border-t border-gray-200/60">
                                <label class="block text-xs font-semibold text-gray-700 mb-1">Custom Description</label>
                        ...
                        <div
                            ...
                            <label class="cursor-pointer block">
                                ...
                                <p class="text-sm text-gray-600 mt-2">Strong, commanding presence with excellent sillage.
                                    Makes a lasting impression. Best for special occasions.</p>
                            </label>
                            <div class="mt-3 pt-3 border-t border-gray-200/60">
                                <label class="block text-xs font-semibold text-gray-700 mb-1">Custom Description</label>
                    ...
                    <p class="text-xs text-gray-500 mt-2">Select the intensity level that best describes this fragrance. You
                        can also customize the description text for each level.</p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="about_scent" id="aboutScentHidden"
                        class="hidden">{{ old('about_scent', $productData['about_scent'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="fragrance_notes" id="fragranceNotesHidden"
                        class="hidden">{{ old('fragrance_notes', $productData['fragrance_notes'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="why_love_it" id="whyLoveHidden"
                        class="hidden">{{ old('why_love_it', $productData['why_love_it'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="what_makes_clean" id="whatCleanHidden"
                        class="hidden">{{ old('what_makes_clean', $productData['what_makes_clean'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="ingredients_details" id="ingredientsDetailsHidden"
                        class="hidden">{{ old('ingredients_details', $productData['ingredients_details'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="shipping_info" id="shippingInfoHidden"
                        class="hidden">{{ old('shipping_info', $productData['shipping_info'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="disclaimer" id="disclaimerHidden"
                        class="hidden">{{ old('disclaimer', $productData['disclaimer'] ?? '') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="ask_question" id="askQuestionHidden"
                        class="hidden">{{ old('ask_question', $productData['ask_question'] ?? '') }}</textarea>
        ...
        <script>
            ...
            function momentsDropdown() {
                return {
                    open: false,
                    search: '',
                    selected: @json(array_map('intval', old('moments', $productData['moments'] ?? []))),
            ...
            function highlightNotesDropdown() {
                return {
                    open: false,
                    search: '',
                    selected: @json(array_map('intval', old('highlight_notes', $productData['highlight_notes'] ?? []))),
            ...
            function scentFamiliesDropdown() {
                return {
                    open: false,
                    search: '',
                    selected: @json(array_map('intval', old('scent_families', $productData['scent_families'] ?? []))),
