...
@section('title', 'Login - Scents N Smile')
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row min-h-[500px]">
                ...
                <div class="p-6 md:p-10 md:w-[60%] flex flex-col">
                    ...
                    <form action="{{ route('user.login.post') }}" method="POST" class="flex-1 flex flex-col">
                        @csrf
                        ...
                        <div class="mt-auto pt-6 text-center">
                            <p class="text-gray-600 text-sm">
                                ...
                                <a href="{{ route('user.register') }}" class="text-[#F27F6E] font-semibold hover:underline">
                                    Create an account
                                </a>
                            </p>
                        </div>
