...
@section('title', 'My Orders - Scents N Smile')
                ...
                <div class="p-4 sm:p-6">
                    <div class="flex flex-wrap gap-4 mb-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                <p class="text-sm font-medium text-gray-900 truncate max-w-[120px]">{{ $item->product_name }}</p>
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4 pt-4 border-t">
                        <div>
                            ...
                            <span class="text-lg font-bold text-[#e8a598] ml-2">₹{{ number_format($order->total, 0) }}</span>
                        </div>
