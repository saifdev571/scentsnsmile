                        ...
                        <div class="w-full md:w-2/3 relative z-10 group" id="products-grid">
                            @if($activeFamily->products->isNotEmpty())
                                ...
                                @if($activeFamily->products->count() > 3)
                                    <button onclick="document.getElementById('scent-products-slider').scrollBy({left: -305, behavior: 'smooth'})" 
                                ...
                                <div id="scent-products-slider" class="flex overflow-x-auto gap-4 py-8 px-4 -mx-4 snap-x snap-proximity hide-scroll-bar scroll-smooth">
